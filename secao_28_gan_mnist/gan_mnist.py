...
from keras_adversarial import AdversarialModel, simple_gan, gan_targets # atualizado/suporta: tensorflow==1.14.0
from keras_adversarial import AdversarialOptimizerSimultaneous, normal_latent_sampling # atualizado/suporta: tensorflow==1.14.0
